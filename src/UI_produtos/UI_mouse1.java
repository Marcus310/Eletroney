...
public class UI_mouse1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI_imagens_produtos/ms.png"))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("<html>Mouse Gamer Dazz Kirata Ascendent, RGB, 8 Botões, 12400DPI - 624632");

        jLabel2.setBackground(new java.awt.Color(153, 153, 255));
        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel2.setText("<html>QUAL É A FUNÇÃO <br><br> Um mouse tem como função navegar <br>pela interface que o monitor apresenta.<br>  <br>\n\n FICHA TECNICA<br>\n <br> - Marca: Dazz\n\n- Modelo: 624632 <br>\n- Sensor: IC PIXAR 3327 12.400DPI<br>\n- Possui Tecnologia RGB de Iluminação<br>\n- Possui 20G de Aceleração e 5000 FPS<br>\n- Tempo de resposta de 1m/s<br>\n- Vida útil: 10 milhões de cliques<br>\n- USB gold<br>");
        jScrollPane1.setViewportView(jLabel2);

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 51));
        jLabel4.setText("R$ 154,90");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_mouse1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
