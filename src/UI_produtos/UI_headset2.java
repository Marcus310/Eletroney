...
public class UI_headset2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI_imagens_produtos/headset2.png"))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("<html>Headset Sem Fio Gamer Corsair Virtuoso Premium Carbono, RGB, Som Surround 7.1, Drivers 50mm, Múltiplas Plataformas - CA-9011185-NA");

        jLabel2.setBackground(new java.awt.Color(153, 153, 255));
        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel2.setText("<html>QUAL É A FUNÇÃO <br><br> Um headset não é nada mais nada menos<br>que um fone de ouvido com comtrole de<br>audio para micofronem, trata-se <br> de um fone de ouvido\n mais parrudão, ou<br>seja com uma qualidade de audio mais alta<br><br>\n\n  FICHA TECNICA<br><br>\n- Marca: Corsair<br>\n- Modelo: CA-9011185-NA<br>\n- Cor: Carbono<br>\n- Conectividade: Sem fio<br>\n- Conexão: USB Wireless Receiver<br>\n- Áudio: 7.1 Surround<br>\n- Alcance sem fio: Aproximadamente <br>18 metros\n- Frequência de resposta: 20Hz - 40 kH<br>\n- Sensibilidade: 109dB (+/- 3dB)<br>\n- Impedância: 32 Ohms @ 2.5 kHz<br>\n- Drivers: 50 mm<br>");
        jScrollPane1.setViewportView(jLabel2);

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 51));
        jLabel4.setText("R$ 899,90");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_headset2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UI_headset2().setVisible(true);
            }
        });
    }
