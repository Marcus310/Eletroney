...
public class UI_gabinete1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI_imagens_produtos/gabinete.png"))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("<html>Gabinete Gamer Sharkoon TG4 Red sem Fonte <br> Mid Tower, USB 3.0, 4 Fans, Preto com Lateral em Vidro");

        jLabel2.setBackground(new java.awt.Color(153, 153, 255));
        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel2.setText("<html>QUAL É A FUNÇÃO <br><br> Um gabinete tem como sua função <br>proteger os componentes internos<br> do computador, componetes como <br> o processador, placa de video e a <br>placa mãe <br>  <br> FICHA TECNICA<br> <br>-Placa mãe: Mini-ITX, Micro-ATX, ATX<br> - Máximo comprimento da placa gráfica:<br> 37,5 cm<br> - Máxima altura do cooler CPU:16 cm<br> - Máximo comprimento da fonte de <br> alimentação: 26,5 cm<br> - USB 3.0 (Top): 2<br> - Áudio (Top)<br> - Marca: Sharkoon<br> - Modelo: TG4<br>   ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_gabinete1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UI_gabinete1().setVisible(true);
            }
        });
    }
