...
public class UI_monitor2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI_imagens_produtos/monitor2.png"))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("<html>Monitor Gamer LG 34' IPS, Curvo Ultra Wide, 144 Hz, Full HD, 1ms, FreeSync, HDR 10, 99% sRGB");

        jLabel2.setBackground(new java.awt.Color(153, 153, 255));
        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel2.setText("<html>QUAL É A FUNÇÃO <br><br> Um monitor tem como sua função<br> mostrar  toda a experiência de forma<br> gráfica , de forma visível ao usuário.<br>  <br> FICHA TECNICA<br> <br>\n\n- Tamanho: 34\" Curvo<br>\n- Tipo de Tela: IPS<br>\n- Brilho: 300 cd/m2<br>\n- Resolução Máxima: 2560 x 1080<br>\n- Contraste Estático: 1000:1<br>\n- Suporte de Cores: 16,7M<br>\n- Pixel Pitch: 0,312 x 0,310<br>\n- Tempo de Resposta: 1ms (MBR)<br>\n- Frequência H: 30 – 164 kHz; <br> V: 56 - 144 Hz <br>\n- Ângulo de Visão: 178°/ 178°<br>\n- Vesa: Sim (100 x 100 mm<br>\n");
        jScrollPane1.setViewportView(jLabel2);

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 51));
        jLabel4.setText("R$ 2.999,90");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_monitor2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UI_monitor2().setVisible(true);
            }
        });
    }
