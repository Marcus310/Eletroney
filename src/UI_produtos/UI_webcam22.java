...
public class UI_webcam22 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI_imagens_produtos/webcam2.png"))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("<html>Webcam Kross, Full HD 1080P, Foco Manual, Tripé Ajustável - KE-WBM1080P");

        jLabel2.setBackground(new java.awt.Color(153, 153, 255));
        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel2.setText("<html>QUAL É A FUNÇÃO <br><br> Uma webcam tem como sus função se<br> comunciar com outras pessoas através<br> do seu computador por meio de video <br>chamdas.<br> \n <br>  \n\n FICHA TECNICA<br>  <br>\n\n- Tipo de Driver: Sem-driver (plug and<br> play)<br>\n- Comprimento do cabo USB: 150 cm<br>\n- Controle de cintilação: 50Hz,60Hz<br>\n- Resolução: 1920x1080<br>\n- Formato da foto: Bmp,Jpg <br>\n- Tipo de interface: USB2.0<br>\n- Tipo de sensor: 1/3” 2M pixel<br>\n- Microfone embutido: Absorção de som<br> e redução de ruído\n- Mecanismo de otimização<br> do contraste: Balanço de contraste<br>\n- Alcance do Foco: Lente 2M pixel<br> f=3.6, ângulo de visão 90º<br>");
        jScrollPane1.setViewportView(jLabel2);

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 51));
        jLabel4.setText("R$ 209,90");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_webcam22.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UI_webcam22().setVisible(true);
            }
        });
    }
