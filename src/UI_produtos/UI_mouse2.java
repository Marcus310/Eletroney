...
public class UI_mouse2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI_imagens_produtos/mouse2.png"))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("<html>Mouse Gamer Husky Gaming Frost, Branco, 12000 DPI, 7 Botões, RGB - HGMH006");

        jLabel2.setBackground(new java.awt.Color(153, 153, 255));
        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel2.setText("<html>QUAL É A FUNÇÃO <br><br> Um mouse tem como função navegar <br>pela interface que o monitor apresenta.<br>  <br>\n\n FICHA TECNICA<br>\n <br> - Marca: Husky Gaming <br>\n- Sensor: Pixart 3360 <br>\n- Resolução (DPI): 12.000 <br>\n- Velocidade de Rastreamento: 250 <br>\n- Aceleração: 50g <br>\n- Iluminação RGB Programável: Sim <br>\n- Memória Integrada: Sim  <br>(possível gravar macros)\n- Polling Rate  <br>1000 Hz <br>\n- Peso líquido: 88,60 g <br>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_mouse2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
