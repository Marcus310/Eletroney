...
public class EletroSql {
    ...
    private String nomeDoBanco = "eletroney";
    private String usuario = "root";
    private String senha = "MaquinaAM-98";
  ...
  //Construtor    
    ...
    public EletroSql(String servidor, String nomeDoBanco, String usuario, String senha){
    ...
    public void conectaBanco(){
        try {
            ...
            //conn = DriverManager.getConnection("jdbc:mysql://localhost3306/eletroney", "root", "root");
